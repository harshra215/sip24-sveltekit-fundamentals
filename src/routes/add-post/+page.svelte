...
<form class="container mx-auto p-5 " method="POST" enctype="multipart/form-data">
    <label for="dropzone" class="mb-3 flex flex-col items-center justify-center w-full h-48 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">
        ...
        <input bind:files name="image" id="dropzone" type="file" accept="image/png,image/peg" class="hidden"/>
    </label>
    <div>
    ...
    <div class="mb-3">
        ...
        <textarea name="content" id="username" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"></textarea>
    </div>
